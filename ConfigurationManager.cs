...
{
    /// <summary>
    /// Code from:  https://code.google.com/p/yet-another-tridion-blog/source/browse/trunk/Yet+Another+Event+System/Com.Mitza.YAES/ConfigurationManager.cs
    ...
    public class ConfigurationManager
    {
        ...
        private string SystemComponentField
        {
            get
            {
                if (String.IsNullOrEmpty(_systemComponentField))
                {
        ...
        private Configuration _dllConfiguration = null;
        /// <summary>
            ...
            if (element != null && schema != null)
            {
                ...
                foreach (string fieldName in SystemComponentField.Split(','))
                {
                    if (metaFields.Contains(fieldName))
                    {
                        ...
                        {
                            if (((ComponentLinkField)itemField).Values.Count > 0)
                            {
